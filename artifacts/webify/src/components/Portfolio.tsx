...
const projects = [
  ...
  },
  {
    ...
    category: "Gym",
    image: "/images/mockup-gym.png",
  },
  {
    title: "Smith & Associates",
    category: "Law Firm",
    image: "/images/mockup-law.png",
  },
  {
    title: "Aura Fashion",
    category: "Boutique",
    image: "/images/mockup-boutique.png",
  },
  {
  ...
  },
  {
    ...
    image: "/images/mockup-photography.png",
  },
];

export default function Portfolio() {
  return (
    <section id="portfolio" className="py-24 bg-background relative z-10">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            >
              We&apos;ve helped diverse local businesses establish a commanding online presence. Explore some of our recent transformations.
            </motion.p>
          </div>
        </div>
